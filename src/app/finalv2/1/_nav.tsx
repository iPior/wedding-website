...
const links = [
  { href: "/finalv2/1", label: "Home" },
  { href: "/finalv2/1/our-story", label: "Our Story" },
  { href: "/finalv2/1/details", label: "Details" },
  { href: "/finalv2/1/faq", label: "FAQ" },
  { href: "/finalv2/1/bridal-party", label: "Party" },
  { href: "/finalv2/1/rsvp", label: "RSVP" },
];
