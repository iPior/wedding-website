    ...
    <div className="space-y-20 text-center">
      ...
      <section className="space-y-6 pt-4">
        <h1
          ...
          style={{ animation: "fadeIn 1.2s ease-out forwards", opacity: 0 }}
        >
          {person1.firstName}
        </h1>
        ...
        <div
          ...
          style={{ animation: "scaleIn 1s ease-out 0.3s forwards", opacity: 0 }}
        >
          <div className="h-px w-16 bg-neutral-300/60" />
          <span className="font-[family-name:var(--font-display)] text-lg font-light text-neutral-400">&amp;</span>
          <div className="h-px w-16 bg-neutral-300/60" />
        </div>

        <h1
          className="font-[family-name:var(--font-display)] text-5xl font-light leading-tight tracking-wide text-neutral-800 sm:text-6xl md:text-7xl"
          style={{ animation: "fadeIn 1.2s ease-out 0.4s forwards", opacity: 0 }}
        >
          {person2.firstName}
        </h1>
      ...
      {/* Countdown */}
      <div style={{ animation: "fadeIn 1s ease-out 1s forwards", opacity: 0 }}>
