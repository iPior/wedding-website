...
const NAV_ITEMS = [
  { label: "Home", href: "/finalv2/2" },
  { label: "Our Story", href: "/finalv2/2/our-story" },
  { label: "Details", href: "/finalv2/2/details" },
  { label: "FAQ", href: "/finalv2/2/faq" },
  { label: "Party", href: "/finalv2/2/bridal-party" },
  { label: "RSVP", href: "/finalv2/2/rsvp" },
];
