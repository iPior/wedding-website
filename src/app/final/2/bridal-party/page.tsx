          ...
          >
            ...
            >
              <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center sm:gap-14">
                <div className="shrink-0">
                  {member.image ? (
                    ...
                    <div className="flex h-32 w-32 items-center justify-center bg-[#f0e0e4] sm:h-40 sm:w-40">
                      <span
                        className="text-3xl tracking-[0.2em] text-[#8a7f7f] sm:text-4xl"
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-[0.3em] text-[#d4a0b0]">
                    {member.role}
                  </p>
                  <h2
                    className="mt-3 text-2xl uppercase tracking-[0.15em] text-[#2c2424] sm:text-3xl"
                    style={{ fontFamily: "var(--font-display)" }}
                  >
                    {member.name}
                  </h2>
                  <p className="mt-3 max-w-md text-sm font-light leading-relaxed text-[#8a7f7f]">
                    {member.bio}
                  </p>
                  <div
                    className="mt-6 h-[2px] bg-[#f0e0e4]"
                    style={{
                      animation: "grow 0.8s ease forwards",
