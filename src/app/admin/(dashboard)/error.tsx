...
export default function AdminDashboardError({
  ...
  return (
    <main className="mx-auto flex min-h-[60vh] max-w-2xl flex-col items-center justify-center px-6 text-center">
      <h1 className="text-3xl font-semibold text-primary">Admin page failed to load</h1>
      <p className="mt-3 text-sm text-foreground-muted">Please retry. If it keeps failing, check Sentry for details.</p>
      <button
